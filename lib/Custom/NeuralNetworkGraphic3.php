...
class NeuralNetworkGraphic3 implements IOutput {

	// Implementation of IBase

	public function getName() {
		return "neuralnetworkgraphic3";
	}
	...
	public function getOutput($out = "html") {
		...
		for ($i = 0; $i < 5000; $i++) {
			...
			$nn->train(array(0, 1), array(1));
			$nn->train(array(1, 0), array(1));
			$nn->train(array(1, 1), array(0));
		}
